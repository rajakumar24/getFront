              ...
              <form autoComplete="off">
                ...
                <div className="form-group">
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <select
                        className="form-control form-txt countySelectionCode"
                ...
                <div className="form-group text-center">
                  ...
                  <label class="form-check-label">
                    Enable Update Through{" "}
                    <a
                      href="https://wa.me/+919513134810?text=I%20am%20intrested%20in%20GetRight%20Property.%20Please%20share%20more%20details!"
                      className="anchertag-whatsapp"
                    >
                      <AiOutlineWhatsApp
                        style={{
                          color: "green",
                      ...
                      />{" "}
                      <span style={{ color: "green" }}>Whats App</span>
                    </a>
                  </label>
                </div>
                <div className="form-btn">
                  <button className="btn btn-call-back" type="submit">
                    <BiPhone
                      style={{
                        color: "white",
                        paddingRight: "2px",
                ...
                <div className="text-center mt-1 mb-1 social-media-title">
                  Social links
                </div>
                <div className="social-media-contact-form">
                  <div className="social-media-box">
                    <a
                      href=" https://www.facebook.com/pages/category/Advertising-Marketing/Get-Right-Property-111223380335151/ "
                      className="anchertag-facebook"
                    >
                      <AiFillFacebook
                        style={{
                          color: "	#4267B2",
                    ...
                    <a
                      href=" https://www.instagram.com/concordeauriga6/ "
                      className="anchertag-instagram"
                    >
                      <img
                        src={instagram}
                        alt="instagram"
