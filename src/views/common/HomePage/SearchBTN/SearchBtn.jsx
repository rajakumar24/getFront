    ...
    <div>
      <div className="search-wrap css-15m0r3w">
        <nav data-q="service" className="css-k008qs">
          <a
            data-q="active"
            className="search-tab search-active-tab css-rzl9ot"
            href="/buy"
          >
            Buy
          </a>
          <a data-q="false" className="search-tab css-1hd5vrj" href="/rent">
            Rent
          </a>
          <a data-q="false" className="search-tab css-1hd5vrj" href="/plot">
            Plot
          </a>
        </nav>
            ...
            <div className="input-container">
              <div>
                <div class="dropdown css-80eldr">
                  <button
                    class="btn btn-default btnDrop dropdown-toggle"
                    type="button"
