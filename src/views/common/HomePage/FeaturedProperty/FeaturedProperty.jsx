  ...
  return (
    <div className="py-3" id="venue">
      <div className="container-fluid">
        <h3 class="font-weight-bold mb-0 FuturePropetyTitle">
          Feuture Property
        </h3>
        <p class="text-muted mb-4 FuturePropetySubTitle">
        ...
        <div className="row bg-primary animate-in-down">
          <div className="p-4 col-md-6 align-self-center text-color">
            ...
            <a href="#" className="btn mb-3 p-2 btn-light btnviewAllPartment ">
              View All Apatment's
            </a>
          </div>
