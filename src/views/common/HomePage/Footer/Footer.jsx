      ...
      <footer className="container-fluid footer">
        <div className="bottom_border">
          <div className="row">
            <div className="col-md col-12 ">
              ...
              <p>
                <i className="fa fa-location-arrow"></i>Bangalore, Karnataka,
                India
              </p>
              <p>
                <i className="fa fa-phone"></i> +91-9513134810{" "}
              </p>
              <p>
                <i className="fa fa fa-envelope"></i> info@rpclan.com{" "}
              </p>
            </div>
        ...
        <div>
          ...
          <p className="text-center">
            Copyright @2021 | <a href="#">Get Right Property</a>
          </p>

          <ul className="social_footer_ul">
            <li>
              <a href="https://m.facebook.com/pages/category/Advertising-Marketing/Get-Right-Property-111223380335151/">
