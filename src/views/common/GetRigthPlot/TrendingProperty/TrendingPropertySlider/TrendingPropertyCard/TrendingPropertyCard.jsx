          ...
          <div class="card-body card-body-imp">
            ...
            <div className="CardBodyInnerData">
              <h5 class="card-title text-left">
                Vibez Pomegranate at Chickballapur
              </h5>
              <div className="row">
                <div className="col-6">
                  <div className="text-left">
                    <small className="text-muted">
                      ...
                      <span>
                        {" "}
                        29 <sup>th</sup> April, 2021{" "}
                      </span>
                    </small>
                  </div>
                  <div className="text-left">
                    <small className="text-muted">
                      Location : <a href="#">Chikkabalapur, Bangalore</a>
                    </small>
                  </div>
                </div>
                <div className="col-6">
                  <div className="text-left">
                    <small className="text-muted">
                      Project Area : <span> 30 Acre</span>
                    </small>
                  </div>
                  <div className="text-left">
                    <small className="text-muted">
                      Total Units : <a href="#">30</a>
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-6">
                  <div className="text-left">
                    <small className="text-muted">
                      Property Type : <span>Agricultural Land</span>
                    </small>
                  </div>
                </div>
                <div className="col-6">
                  <div className="text-left">
                    <small className="text-muted">
                      Status : <span> Ready To Move</span>
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div className="TrendingPropertyCardText">
                <p class="card-text">
                  Looking for a wise investment plan with good returns for your
                  hard-earned money? Consider investing in a pomegranate
                  plantation in Karnataka near Bangalore having optimal
                  environment and soil conditions required for a good yield{" "}
                </p>
              </div>
              ...
              <div className="FlexSpaceBtn pt-2">
                <a href="" class="btn btn-outline-success btn-sm ml-1">
                  Book Now
                </a>
                <a href="" class="btn btn-outline-success btn-sm ml-1">
                  Contact
