        ...
        <div class="card trendingProperty">
          ...
          <div class="card-body card-body-imp">
            ...
            <div className="CardBodyInnerData">
              ...
              <div className="text-left">
                <small className="text-muted">
                  Location : <a href="#">Bangalore, White Field</a>
                </small>
              </div>
              <div className="text-left">
                <strong>About</strong>
              ...
              <div className="TrendingPropertyCardText">
                <p class="card-text">
                  ...
                  eum similique repellat Lorem ipsum dolor sit amet consectetur,
                  adipisicing elit. Ut eum similique repellat{" "}
                </p>
              </div>
              ...
              <div className="row">
                <div className="col-md-4  p-1">
                  ...
                  >
                    <i class="fas fa-rupee-sign"></i> : 10,000 K - 15,000 K
                  </strong>
                </div>
                <div className="col-md-4  p-1">
                  <strong
