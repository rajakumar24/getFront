          ...
          <div className="propertydisplay">
                    ...
                    <div className="propertydisplay__bodyTwoPartTable">
                      <div className="propertydisplay__bodyTwoPartTableContainerOne">
                        ...
                        <p className="">
                          ...
                          <br />{" "}
                          <span style={{ color: "#979b9b", fontSize: "13px" }}>
                            Availability*:
                          </span>{" "}
                      ...
                      <div className="propertydisplay__bodyTwoPartTableContainerOne">
                        ...
                        <p className="" style={{ marginTop: "2px" }}>
                          ...
                          <br />{" "}
                          <span style={{ color: "#979b9b", fontSize: "12px" }}>
                            (55.56 sq.m)
                          </span>{" "}
                        </p>
                        <p className="" style={{ marginTop: "2px" }}>
                        ...
                        >
                          ...
                          >
                            ...
                            <p style={{ color: "#696b6b", fontSize: "13px" }}>
                              Discover India's largest and most loved coworking
                              network
                            </p>
                          </div>
                        </a>
                ...
                >
                  <div className="propertydisplay__bodyOneDetailPartOneColumn">
                    ...
                    <span style={{ color: "#979b9b", fontSize: "15px" }}>
                      ...
                      ambition and a vision of a sustainable India. Grounded in
                      trust and loyalty, these values have become the solid
            ...
            <div className="box_containerType6">
              <div className="Row">
                ...
                <div
                  style={{ width: "400px", float: "left", marginTop: "-10px" }}
                >
            ...
            <div
              className="separator"
              style={{ width: "900px", marginLeft: "20px", marginTop: "20px" }}
            ></div>
            <p className="black__title">Related Question about this property</p>
            {question != null &&
